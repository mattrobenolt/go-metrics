...
//
// Expiration occurs during collection (e.g. WritePrometheus). The maximum
// lifetime of a Set after its last activity is 'ttl + (interval between
// WritePrometheus calls)'.
//
