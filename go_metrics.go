...
func writeGoMetrics(w io.Writer) {
	...
	WriteMetricUint64(w, "go_memstats_alloc_bytes", ms.Alloc)
	WriteMetricUint64(w, "go_memstats_alloc_bytes_total", ms.TotalAlloc)
	WriteMetricUint64(w, "go_memstats_buck_hash_sys_bytes", ms.BuckHashSys)
	WriteMetricUint64(w, "go_memstats_frees_total", ms.Frees)
	WriteMetricFloat64(w, "go_memstats_gc_cpu_fraction", ms.GCCPUFraction)
	WriteMetricUint64(w, "go_memstats_gc_sys_bytes", ms.GCSys)

	WriteMetricUint64(w, "go_memstats_heap_alloc_bytes", ms.HeapAlloc)
	WriteMetricUint64(w, "go_memstats_heap_idle_bytes", ms.HeapIdle)
	WriteMetricUint64(w, "go_memstats_heap_inuse_bytes", ms.HeapInuse)
	WriteMetricUint64(w, "go_memstats_heap_objects", ms.HeapObjects)
	WriteMetricUint64(w, "go_memstats_heap_released_bytes", ms.HeapReleased)
	WriteMetricUint64(w, "go_memstats_heap_sys_bytes", ms.HeapSys)
	WriteMetricFloat64(w, "go_memstats_last_gc_time_seconds", float64(ms.LastGC)/1e9)
	WriteMetricUint64(w, "go_memstats_lookups_total", ms.Lookups)
	WriteMetricUint64(w, "go_memstats_mallocs_total", ms.Mallocs)
	WriteMetricUint64(w, "go_memstats_mcache_inuse_bytes", ms.MCacheInuse)
	WriteMetricUint64(w, "go_memstats_mcache_sys_bytes", ms.MCacheSys)
	WriteMetricUint64(w, "go_memstats_mspan_inuse_bytes", ms.MSpanInuse)
	WriteMetricUint64(w, "go_memstats_mspan_sys_bytes", ms.MSpanSys)
	WriteMetricUint64(w, "go_memstats_next_gc_bytes", ms.NextGC)
	WriteMetricUint64(w, "go_memstats_other_sys_bytes", ms.OtherSys)
	WriteMetricUint64(w, "go_memstats_stack_inuse_bytes", ms.StackInuse)
	WriteMetricUint64(w, "go_memstats_stack_sys_bytes", ms.StackSys)
	WriteMetricUint64(w, "go_memstats_sys_bytes", ms.Sys)

	WriteMetricUint64(w, "go_cgo_calls_count", uint64(runtime.NumCgoCall()))
	WriteMetricUint64(w, "go_cpu_count", uint64(runtime.NumCPU()))
	...
	WriteMetricUint64(w, "go_gc_forced_count", uint64(ms.NumForcedGC))

	WriteMetricUint64(w, "go_gomaxprocs", uint64(runtime.GOMAXPROCS(0)))
	WriteMetricUint64(w, "go_goroutines", uint64(runtime.NumGoroutine()))
	numThread, _ := runtime.ThreadCreateProfile(nil)
	WriteMetricUint64(w, "go_threads", uint64(numThread))
...
func writeRuntimeMetric(w io.Writer, name string, sample *runtimemetrics.Sample) {
	...
	case runtimemetrics.KindUint64:
		...
		WriteMetricUint64(w, name, v)
	case runtimemetrics.KindFloat64:
		v := sample.Value.Float64()
		WriteMetricFloat64(w, name, v)
